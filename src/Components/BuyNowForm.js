...
const BuyNowForm=(props)=> {
    ...
    const handler=(e)=>{
        ...
        props.history.push('/buynowpayment')
    }
    return (
        <div>
            ...
            <form onSubmit={e=>{handler(e)}}>
                ...
                <div className="form-group">
                    ...
                    <input className="form-control" value={mobValue} required onChange={e=>setMobValue(e.target.value)} placeholder="Mobile Number" type="text"></input>
                </div>

                <div className="form-group">
                    <label>PinCode</label>
                    <input className="form-control"value={pinValue} required onChange={e=>setPinValue(e.target.value)} placeholder="Pincode" type="text"></input>
                </div>

                <div className="form-group">
                    <label>Address</label>
                    <textarea className="form-control" value={addressValue} required onChange={e=>setAddressValue(e.target.value)} placeholder="Flat Number/Colony" type="text"></textarea>
                </div>
...
export default connect(mapStateToprops,{name,mob,pin,address,state })(BuyNowForm);